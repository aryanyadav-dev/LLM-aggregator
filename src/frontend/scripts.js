...
async function handleSubmit(event) {
    ...
    try {
        // Set your Flask server's URL here (adjust as needed)
        const serverUrl = 'http://localhost:5000/generate';
        ...
        // Show the response container (ensure the container exists in HTML)
